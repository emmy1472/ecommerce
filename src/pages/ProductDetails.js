...
const ProductDetails = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://1307-197-253-32-226.ngrok-free.app/api/products/products/${id}/`);
        ...
        <div className="container my-5"><br></br><br></br>
            ...
            <div className="row">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                    <img 
                        src={`https://1307-197-253-32-226.ngrok-free.app/api/products${product.image}`} 
                        alt={product.name} 
